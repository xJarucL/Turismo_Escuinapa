<header class="fixed top-0 left-0 right-0 z-50 border-b border-gray-300 shadow-sm bg-red-600 transition-shadow duration-300">
  <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <div class="hidden md:flex space-x-6 items-center text-white font-medium font-serif">
        ...
        <a href="{{ route('administrador') }}" class="hover:underline">Inicio</a>
        <a href="{{ route('lista_usuarios') }}" class="hover:underline">Usuarios</a>
  ...
  <div id="sideMenu" class="md:hidden font-serif fixed top-0 left-0 w-72 h-screen bg-gradient-to-b from-zinc-50 to-zinc-50 shadow-xl z-40 overflow-y-auto rounded-r-xl transform -translate-x-full transition-transform duration-300">
    <div class="p-4 border-b border-red-200 flex justify-between items-center bg-red-600 rounded-tr-xl">
      <span class="text-lg font-serif text-white">Opciones Admin</span>
    ...
    <nav class="flex flex-col space-y-3 p-4">
      <a href="{{ route('administrador') }}" class="px-4 py-3 rounded-lg text-red-900 hover:bg-red-200 hover:text-red-800 font-medium transition-all duration-200 transform hover:translate-x-2 hover:shadow-sm">
        Inicio
      </a>
      <a href="{{ route('lista_usuarios') }}" class="px-4 py-3 rounded-lg text-red-900 hover:bg-red-200 hover:text-red-800 font-medium transition-all duration-200 transform hover:translate-x-2 hover:shadow-sm">
        Usuarios
      </a>
