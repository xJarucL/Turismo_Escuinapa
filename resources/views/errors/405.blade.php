...
<div class="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-100 via-yellow-100 to-gray-100 overflow-hidden px-6 py-10">
    ...
    <div class="z-10 text-center flex flex-col items-center space-y-6 max-w-2xl">
        ...
        <h1 class="text-3xl font-bold text-red-600">Método no permitido</h1>

        <p class="text-gray-700 text-lg">
            El método HTTP utilizado no está permitido para esta URL.
        </p>
        <p class="text-gray-600 max-w-md">
            Por favor verifica que la solicitud sea correcta o regresa a la página anterior para intentarlo de nuevo.
        </p>
