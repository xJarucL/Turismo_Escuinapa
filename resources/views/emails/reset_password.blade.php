                ...
                <table align="center" width="100%" max-width="600px" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center; background-color: #1f2937;">
                            <h2 style="color: #ffffff; margin: 0;">Turismo Escuinapa</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="text-align: center; margin: 30px 0;">
                                <a href="{{ url('/reset-password?token=' . $token) }}"
                                   style="padding: 12px 24px; background-color: #dc2626; color: #ffffff;
                            ...
                            <p style="font-size: 14px; color: #555555;">Saludos,<br><strong>El equipo de Seguridad de Turismo Escuinapa</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size: 12px; color: #aaaaaa; padding: 20px; background-color: #f9fafb;">
                            © 2025 Turismo Escuinapa. Todos los derechos reservados.
                        </td>
                    </tr>
                </table>
            </td>
